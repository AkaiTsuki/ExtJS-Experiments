(function() {
	Ext.define('LabApp.controller.LabControl', {
		...
		requires : [ 'LabApp.view.panel.BasicPanel',
				'LabApp.view.grid.ArrayGrid', 'LabApp.view.grid.GroupGrid',
				'LabApp.view.grid.GroupHeaderGrid' ],
				...
				'treenavigation' : {
					itemclick : function(tree, record) {
						...
						if (record.data.leaf) {
							...
							Ext.getCmp('documentpanel')
									.update(record.data.text);
							center.removeAll();
